 ...
 */
talentScreen.controller('choiceQuizController', ['$scope', '$http', 'tsSubject',
    function ($scope, $http, tsSubject) {
        ...
        $scope.subjectId = 0;
        $scope.questionsCountRange = "10-15";
        $scope.timerExecutionInProcess = false;

        //$scope.subjects = [{id: 34, name: "ASP.NET Web Forms"},{id: 35, name: "ASP.NET MVC and Web API"},{id: 36, name: "Microsoft Entity Framework"},{id: 37, name: "Microsoft .NET with C#"},{id: 38, name: "Http and Web"},{id: 39, name: "SDLC + Architectures"},{id: 40, name: "Web Services"},{id: 41, name: "Work Management Tools"},{id: 42, name: "SQL"},{id: 43, name: "CSS"},{id: 44, name: "MongoDB"},{id: 45, name: "NoSQL Fundamentals"},{id: 46, name: "Android Fundamentals"},{id: 47, name: "SOAPUI"},{id: 48, name: "Java Programming"},{id: 49, name: "Testing Fundamentals"},{id: 50, name: "Performance Testing Fundamentalas"},{id: 51, name: "Jmeter"},{id: 52, name: "Unit Testing"},{id: 53, name: "Selenium WebDriver"},{id: 54, name: "QA Automation"},{id: 55, name: "Appium"},{id: 56, name: "Javascript Programming"},{id: 57, name: "HTML5"},{id: 58, name: "jQuery"},{id: 59, name: "Bootstrap"},{id: 60, name: "Javascript UI"},{id: 61, name: "AngularJS"},{id: 62, name: "Javascript Testing"},{id: 63, name: "Javascript Build Automation"},{id: 64, name: "NodeJS"},{id: 65, name: "ExpressJS"},{id: 97, name: "UNIX"},{id: 98, name: "Java DevOps"},{id: 99, name: "Python Programming"},{id: 100, name: "QTP"},{id: 101, name: "Loadrunner"},{id: 102, name: "WebDesigning"}];
        tsSubject.query().$promise.then(function (data) {
            console.log(data);
            $scope.subjects = data;
        });
        ...
        $scope.subjectChanged = function () {
            if ($scope.selectSubject) {
                ...
                $scope.questionNo = 1;
                setQuestion($scope.questionNo - 1);
        ...
        function setQuestion(questionNumber) {
            $scope.questionText = $scope.questions[questionNumber].question;
            $scope.answer1Text = $scope.questions[questionNumber].answer1;
            $scope.answer2Text = $scope.questions[questionNumber].answer2;
            $scope.answer3Text = $scope.questions[questionNumber].answer3;
            $scope.answer4Text = $scope.questions[questionNumber].answer4;
            $scope.answer1 = false;
            $scope.answer2 = false;
            $scope.answer3 = false;
            $scope.answer4 = false;
        ...
        function moveToNextQuestion(timerFinished) {

        }

        $scope.finished = function () {
            if ($scope.timerRunning) {
                $scope.timerExecutionInProcess = true;
